...
create table products(productId int primary key, productName varchar(20), categoryId int references categories(categoryId), price money, description varchar(40))

create table orderDetails(orderItemId int primary key, userId int primary key references users(userId),
